...
// Toggle settings
router.post("/toggle/push-notifications", userSettingsController.togglePushNotifications);
router.post("/toggle/automated-calls", userSettingsController.toggleAutomatedCalls);
router.post("/toggle/dark-mode", userSettingsController.toggleDarkMode);
exports.default = router;
//# sourceMappingURL=user-settings.routes.js.map